      ...
      <div className="content-area">
        ...
        <div className="main-content">
          <Routes>
            ...
            <Route path="/alunos" element={<ProtectedRoute adminOnly={true}><Alunos /></ProtectedRoute>} />
            ...
            <Route path="/admins" element={<ProtectedRoute adminOnly={true}><Admins /></ProtectedRoute>} />
